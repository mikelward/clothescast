...
internal fun SmartHomeContent(
    ...
    castMorningEnabled: Boolean,
    castTonightEnabled: Boolean,
    castSkipPhoneSpeech: Boolean,
    castWakeDisplay: Boolean,
    castInterruptPlaying: Boolean,
    castGeminiWarningVisible: Boolean,
    ...
    onCastNow: () -> Unit,
    onSetCastMorningEnabled: (Boolean) -> Unit,
    onSetCastTonightEnabled: (Boolean) -> Unit,
    onSetCastSkipPhoneSpeech: (Boolean) -> Unit,
    onSetCastWakeDisplay: (Boolean) -> Unit,
    onSetCastInterruptPlaying: (Boolean) -> Unit,
) {
        ...
        Column(
            ...
            if (castAvailable) {
                CastDestinationCard(
                    ...
                    morningEnabled = castMorningEnabled,
                    tonightEnabled = castTonightEnabled,
                    skipPhoneSpeech = castSkipPhoneSpeech,
                    wakeDisplay = castWakeDisplay,
                    interruptPlaying = castInterruptPlaying,
                    geminiWarningVisible = castGeminiWarningVisible,
                    ...
                    onCastNow = onCastNow,
                    onSetMorningEnabled = onSetCastMorningEnabled,
                    onSetTonightEnabled = onSetCastTonightEnabled,
                    onSetSkipPhoneSpeech = onSetCastSkipPhoneSpeech,
                    onSetWakeDisplay = onSetCastWakeDisplay,
                    onSetInterruptPlaying = onSetCastInterruptPlaying,
                )
            }
            MqttBridgeCard(
