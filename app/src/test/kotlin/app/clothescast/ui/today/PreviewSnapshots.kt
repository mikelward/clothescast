...
import app.clothescast.widget.WidgetTonightCoatPantsGlovesPreview
...
class PreviewSnapshots {
    ...
    @Test fun widget_tonight_coat_pants_gloves() = capture { WidgetTonightCoatPantsGlovesPreview() }
